...
def draw_boxes(img, bbox, names,object_id, identities=None, offset=(0, 0)):
    ...
    #4. Display Count in top right corner
        ...
        total_cars_crossing = sum(object_counter.values()) + sum(object_counter1.values())
        cv2.putText(img, f'Total Cars Crossing: {total_cars_crossing}', (width - 500, 150), 0, 1, [225, 255, 255], thickness=2,
